...
if __name__ == '__main__':
    ...
    parser.add_argument("--env_id", help="Name of environment", default="cache_data")
    ...
    parser.add_argument("--n_episodes", default=1000, type=int) # 10000 better
    parser.add_argument("--episode_length", default=200, type=int) # TODO increase the lenghth 25
